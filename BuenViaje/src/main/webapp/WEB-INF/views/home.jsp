...
<header>
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark scrolling-navbar">
    <a class="navbar-brand" href="${context}/"><strong>Buen Viaje</strong></a>
  ...
  <div id="intro" class="view intro-2" style="height: 600px">
      ...
      <div class="mask rgba-purple-light flex-center">
        <div class="container text-center white-text wow fadeInUp">
           ...
           <div class="logo"> 
             ...
             <%-- <img src="${context}/resources/images/homeW.png" width=80%> --%>
